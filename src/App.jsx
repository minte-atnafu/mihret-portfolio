  ...
  return (
    <div className="portfolio-shell">
      ...
      <main id="top">
        ...
        <section id="contact" className="contact-section"><div className="wrap"><p className="eyebrow">Start a conversation</p><h2>Have an idea<br /><em>worth making?</em></h2><form className="contact-form" action="https://formspree.io/f/mjybnnqo" method="POST"><input type="hidden" name="_subject" value="New portfolio inquiry" /><div className="contact-fields"><label>Name<input name="name" type="text" required /></label><label>Email<input name="email" type="email" required /></label><label>Phone<input name="phone" type="tel" /></label></div><label>Message<textarea name="message" rows="5" required /></label><button className="contact-submit" type="submit">Send message <span>↗</span></button></form><a className="contact-email" href="mailto:mhireterkihunsep@gmail.com">mhireterkihunsep@gmail.com <span>↗</span></a><div className="socials"><a href="https://instagram.com/phinhans4" target="_blank" rel="noreferrer">Instagram</a><a href="https://t.me/Binthakim19" target="_blank" rel="noreferrer">Telegram</a></div></div></section>
      </main>
